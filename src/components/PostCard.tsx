      ...
      <div className="flex items-center gap-1 px-4 py-3 border-b border-border">
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
            liked ? "text-red-400 bg-red-400/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
          }`}
        >
          <Heart className="w-4 h-4" fill={liked ? "currentColor" : "none"} />
          <span>{formatCount(likeCount)}</span>
        </button>
        <button className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-all">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 ml-auto ${
            saved ? "text-amber bg-amber/10" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
          }`}
        >
