                ...
                {searchOpen ? (
                  ...
                  >
                    <input
                      ...
                      className="w-full h-9 pl-9 pr-9 rounded-lg bg-muted text-sm text-foreground placeholder:text-muted-foreground border border-white/10 outline-none focus:border-amber/50 transition-colors"
                    />
