          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-5">
                <SocialIcon id="google" label="Google" onClick={() => handleOAuth("google")}>
